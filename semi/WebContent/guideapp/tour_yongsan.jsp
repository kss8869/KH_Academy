...
<div id="tour_detail_first">
	<div>
		<p>상품 조회수:<%=arr.get(1).getReadnum() %></p>
		<p>&#91;서울시지원&#93;서울을 한눈 에 볼수 있는! 용산으로 놀러오세요~</p>
	</div>
...
<div id="tour_detail_second" align="center">
	<div align="center">
		...
		<table border="1" id="tour_detail_second_table1">
			<tr>
				<td>포함내역</td>
				<td>불포함 내역</td>
			</tr>
		...
		<table border="1">
			...
			<tbody>
				...
				<tr>
					<td>서울</td>
					<td>
						<p>&#91;07:00&#93; 서울시 강남구 역삼역 기업은행앞 &#40;10분전 집결&#41;</p>
						->2호선 역삼역 3번출구
						<p>[07:20] 역삼역 포스코 p &#38;s 건물 맞은편 버스정류장&#40;10분전 집결&#41;</p>
					 </td>
				</tr>
				<tr>
				...
				<tr>
					<td>서울</td>
					<td>
						<p>&#91;18:00&#93; 서울 역삼역 도착 및 해산 </p>
					</td>
				</tr>
			</tbody>
			<tfoot>
				<tr>
					<td colspan="2"><p>모든 여행일정종료 !</p></td>
				</tr>
			</tfoot>
		</table>
	</div>
	...
	<table border="1">
		<tr>
			...
			<td>
				...
				<p>1.  여행개시 3일전까지 변경 및 취소 통보 시 » 전액 환불</p>
				<p>2.  여행개시 2일전까지 변경 및 취소 통보 시 » 요금의 80%환불</p>
				<p>3.  여행개시 1일전까지 변경 및 취소 통보 시 » 요금의 70%환불</p>
				<p>4.  여행 당일 취소 통보 시 » 환불없음</p>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<p>3. 상품별 최소 출발인원 부족시 행사가 취소될 수 있으며, 출발 최소 2일전에 연락을 드립니다. (모객 미달 시 입금액 100% 환불)</p>
				<p>4. 탑승하실 버스의 좌석배치는 예약접수순으로 배정되며, 동행인분과는 최대한 옆자리로 배정합니다.</p>
				<p>5. 여행자보험 가입을 위해서 예약시 예약자를 포함한 일행 모두의 주민번호를 꼭 기입해 주시기 바랍니다.</p>
				<p>6. 우천시에도 행사는 진행이 됩니다.</p>
				<p>7. 애완동물은 여행에 참여할 수 없으니 유의하시기 바랍니다.</p>
			</td>
		</tr>
		<tr>
			<td><p>준비물</p></td>
			<td><p>편한복장, 신분증 및 개별준비물, 여벌옷, 식수, 간식거리 등</p></td>
		</tr>
		<tr>
			<td>여권 및 비자</td>
			<td>필요 없음</td>
