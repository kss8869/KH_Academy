...
<div id="tour_detail_first">
	<div>
		<p>상품조회수:<%=arr.get(0).getReadnum() %></p>
		<p>&#91;서울시지원&#93;서을의 트렌드 강남으로 놀러오세요~</p>
	</div>
	...
	<div class="div_1">
		<table>
			<tr>
				<td>
					<img src="guideapp/img/tourlist/gn_1_1.JPG">
					<img src="guideapp/img/tourlist/gn_1_2.JPG">
					<img src="guideapp/img/tourlist/gn_1_3.JPG">
					<img src="guideapp/img/tourlist/gn_1_4.JPG">
				</td>	
			</tr>
			<tr>
				<td>
