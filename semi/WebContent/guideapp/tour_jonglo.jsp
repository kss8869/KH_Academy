...
<div id="tour_detail_first">
	<div>
		<p>상품조회수:<%=arr.get(6).getReadnum() %></p>
		<p>&#91;서울시지원&#93;서울의 중심 종로구로 놀러오세요~</p>
	</div>
	...
	<div class="div_1">
		<table>
			<tr>
				<td>
					<img src="guideapp/img/tourlist/jp_2_1.png">
					<img src="guideapp/img/tourlist/jp_4_2.jpg">
					<img src="guideapp/img/tourlist/jp_5_09.png">
					<img src="guideapp/img/tourlist/jp_6_1.jpg">
				</td>	
			</tr>
			<tr>
				<td>
