...
<%
 String localidx= request.getParameter("idx");
%>
<body>
<div id="tour_detail_first">
	<div>
		<p>상품조회수:</p>
		<p>&#91;서울시지원&#93;서울 서대문으로 놀러오세요~</p>
	</div>
	...
	<div class="div_1">
		<table>
			<tr>
				<td>
					<img src="guideapp/img/tourlist/sp_4_3.jpg">
					<img src="guideapp/img/tourlist/sp_2_4.jpg">
					<img src="guideapp/img/tourlist/sp_3_5.jpg">
					<img src="guideapp/img/tourlist/sp_6_7.jpg">
				</td>	
			</tr>
			<tr>
				<td>
