...
<div id="tour_detail_first">
	<div>
		<p>상품조회수:<%=arr.get(2).getReadnum() %></p>
		<p>&#91;서울시지원&#93;서울 마포구로 놀러오세요~</p>
	</div>
	...
	<div class="div_1">
		<table>
			<tr>
				<td>
					<img src="guideapp/img/tourlist/mf_1_1.JPG">
					<img src="guideapp/img/tourlist/mf_1_2.JPG">
					<img src="guideapp/img/tourlist/mf_1_3.JPG">
					<img src="guideapp/img/tourlist/mf_1_4.JPG">
				</td>	
			</tr>
			<tr>
				<td>
