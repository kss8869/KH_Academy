...
<%@ page import="course.*" %>
<jsp:useBean id="sfdao" class="course.SeochoFoodDAO" scope="page"/>
<jsp:useBean id="spdao" class="course.SeochoPlaceDAO" scope="page"/>
...
SeochoPlaceDTO dto=spdao.courseContent(idx);
