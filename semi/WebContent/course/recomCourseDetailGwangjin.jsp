...
<%@ page import="course.*" %>
<jsp:useBean id="gwfdao" class="course.GwangjinFoodDAO" scope="page"/>
<jsp:useBean id="gwpdao" class="course.GwangjinPlaceDAO" scope="page"/>
...
GwangjinPlaceDTO dto=gwpdao.courseContent(idx);
